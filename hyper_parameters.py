...
tf.app.flags.DEFINE_string('train_path', r'D:\program\liuyang\liuyang\interpreting_data\cifar10\data\csv_file\train.csv',
                           ''' path of train data''')
tf.app.flags.DEFINE_string('vali_path', r'D:\program\liuyang\liuyang\interpreting_data\cifar10\data\csv_file\test.csv',
...
tf.app.flags.DEFINE_string('ckpt_path', 'logs_vgg', '''Checkpoint
